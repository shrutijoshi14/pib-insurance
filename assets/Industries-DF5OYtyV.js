import{f as e,l as t,m as n,t as r}from"./proxy-B3mupvaD.js";import{t as i}from"./index-D1kFFYev.js";import{n as a,r as o,t as s}from"./MotionWrappers-D7oZwAqf.js";import{t as c}from"./SEO-AaUxQtOi.js";var l=n(e(),1),u={it:{title:`IT companies`,icon:`fa-laptop-code`,desc:`
        ...
        `},logistics:{title:`Logistics`,icon:`fa-truck-fast`,desc:`
            <div class="modal-inner-content">
        ...
        `},law:{title:`Law firms`,icon:`fa-scale-balanced`,desc:`
            <div class="modal-inner-content">
        ...
        `},realestate:{title:`Real Estate`,icon:`fa-city`,desc:`
            <div class="modal-inner-content">
        ...
        `},retail:{title:`Retail`,icon:`fa-cart-shopping`,desc:`
            <div class="modal-inner-content">
        ...
        `},manufacturing:{title:`Manufacturing`,icon:`fa-industry`,desc:`
            <div class="modal-inner-content">
        ...
        `},mining:{title:`Mining`,icon:`fa-helmet-safety`,desc:`
            <div class="modal-inner-content">
        ...
        `},infrastructure:{title:`Infrastructure`,icon:`fa-bridge-water`,desc:`
            <div class="modal-inner-content">
        ...
        `},energy:{title:`Energy`,icon:`fa-bolt-lightning`,desc:`
            <div class="modal-inner-content">
        ...
        `},hospitality:{title:`Hospitality`,icon:`fa-hotel`,desc:`
            <div class="modal-inner-content">
        ...
        `},food:{title:`Food & Beverage`,icon:`fa-utensils`,desc:`
            <div class="modal-inner-content">
        ...
        `},aviation:{title:`Aviation & Space`,icon:`fa-plane-up`,desc:`
            <div class="modal-inner-content">
        ...
        `},entertainment:{title:`Entertainment & Media`,icon:`fa-film`,desc:`
            <div class="modal-inner-content">
        ...
        `},healthcare:{title:`Healthcare & Pharma`,icon:`fa-staff-snake`,desc:`
            <div class="modal-inner-content">
        ...
        `},chemical:{title:`Chemical Industry`,icon:`fa-flask-vial`,desc:`
            <div class="modal-inner-content">
                <h3>Insurance Solutions for the Chemical Industry (India)</h3>
                <p class="section-title">Industry Overview</p>
                <p>India has solidified its position as the <strong>third-largest chemical producer globally</strong>, trailing only China and the US. With the industry projected to reach a valuation of <strong>$200 billion by 2026</strong>, the sector now contributes nearly <strong>13% of India’s total manufacturing output</strong>. From the sprawling petrochemical hubs in Gujarat and Maharashtra to the high-growth specialty chemical clusters across the country, this industry is the engine driving India's "Make in India" and <strong>PLI (Production Linked Incentive)</strong> success stories.</p>
                <p>However, this rapid scaling is met with a rigorous regulatory environment and high operational stakes. Facilities must comply with the <strong>Public Liability Insurance (PLI) Act of 1991, PESO (Petroleum and Explosives Safety Organization)</strong> standards, and stringent MoEFCC (Ministry of Environment, Forest and Climate Change) norms. A single chemical spill or reactor failure in a densely populated industrial zone doesn't just halt production—it triggers massive legal liabilities, environmental remediation costs, and potential shutdown orders from State Pollution Control Boards.</p>

                <div class="solutions-grid mt-4">
                    <h4>Our Insurance Solutions for the Indian Chemical Industry</h4>
                    <p>At <strong>PIB Insurance Brokers</strong>, we provide a safety net that aligns with the specific statutory requirements and logistical challenges of the Indian market:</p>
                    <ul class="modal-list">
                        <li><strong>Public Liability (Statutory) Insurance:</strong> A mandatory requirement under the Indian PLI Act for units handling hazardous substances, providing immediate relief to third parties in case of industrial accidents.</li>
                        <li><strong>Specialty Chemical & API Liability:</strong> With the surge in domestic <strong>API (Active Pharmaceutical Ingredient)</strong> manufacturing, we offer specific covers for batch contamination and product recall that protect against global supply chain disruptions.</li>
                        <li><strong>Environmental & Pollution Legal Liability:</strong> Comprehensive protection against both "gradual" and "sudden" pollution, covering cleanup costs and legal defense in line with the Environment Protection Act.</li>
                        <li><strong>Mega-Risk Property & Fire Insurance:</strong> Tailored for high-asset-value complexes, protecting distillation units, storage farms, and reactors against explosions, fire, and natural catastrophes like cyclones and floods.</li>
                        <li><strong>Marine & Inland Transit (Hazardous Cargo):</strong> Specialized cover for moving hazardous materials across India’s vast infrastructure, addressing the unique risks of road transit and port congestion.</li>
                    </ul>
                </div>
            </div>
        `},education:{title:`Education`,icon:`fa-graduation-cap`,desc:`
            <div class="modal-inner-content">
                <h3>Insurance Solutions for the Education Industry (India)</h3>
                <p class="section-title">Industry Overview</p>
                <p>With over <strong>250 million students</strong> enrolled across schools and universities, India represents one of the world’s largest and most complex education markets. The landscape is currently being redefined by the <strong>National Education Policy (NEP) 2020</strong>, which is driving a massive shift toward multidisciplinary institutions and digital-first learning models. From premier K-12 private schools in urban centers to the sprawling coaching hubs of Rajasthan and Telangana, the sector is under more scrutiny than ever.</p>
                <p>The most significant shift in 2026 is the implementation of the <strong>Digital Personal Data Protection (DPDP) Act.</strong> With any individual under 18 classified as a child, educational institutions and EdTech platforms now face "Significant Data Fiduciary" responsibilities. A breach of student data or failure to obtain "verifiable parental consent" can result in penalties of up to <strong>₹250 crore</strong>. Beyond data, physical safety—ranging from fire compliance in coaching centers to laboratory accidents—remains a top priority for administrators and trustees.</p>

                <div class="solutions-grid mt-4">
                    <h4>Our Insurance Solutions for the Indian Education Industry</h4>
                    <p>We help institutions navigate this evolving regulatory and digital landscape with robust risk transfer solutions:</p>
                    <ul class="modal-list">
                        <li><strong>DPDP Act & Cyber Liability Insurance:</strong> A critical cover for 2026, protecting schools and EdTech firms against data breaches, ransomware, and the high costs of compliance and penalties under the new Data Protection Board of India.</li>
                        <li><strong>Professional Indemnity for Educators:</strong> Protects the management and faculty against claims of "deficiency in service," academic negligence, or failure to meet the multidisciplinary standards set by NEP 2020.</li>
                        <li><strong>Student Safety & Group Personal Accident:</strong> Customized policies providing medical and accidental cover for students on campus, during school bus transit, or on educational tours.</li>
                        <li><strong>Directors & Officers (D&O) Liability:</strong> Essential for school boards and trust members to protect personal assets against litigation regarding fee-regulation disputes, governance issues, or administrative decisions.</li>
                        <li><strong>Campus Property & Fire Safety Insurance:</strong> Ensuring that libraries, high-end labs, and sports infrastructure are protected against fire and natural perils, while meeting local municipal safety norms.</li>
                        <li><strong>Business Interruption (Fee Loss):</strong> Protects the institution’s cash flow in the event of a forced closure due to accidental damage or a localized disaster.</li>
                    </ul>
                </div>
            </div>
        `},ironsteel:{title:`Iron & Steel`,icon:`fa-gears`,desc:`
            <div class="modal-inner-content">
        ...
        `},sugar:{title:`Sugar Industry`,icon:`fa-cubes`,desc:`
            <div class="modal-inner-content">
        ...
        `},solarwind:{title:`Solar & Wind`,icon:`fa-solar-panel`,desc:`
            <div class="modal-inner-content">
        ...
        `},tea:{title:`Tea Industry`,icon:`fa-leaf`,desc:`
            <div class="modal-inner-content">
        ...
        `},agriculture:{title:`Agriculture`,icon:`fa-tractor`,desc:`
            <div class="modal-inner-content">
        ...
        `},plywood:{title:`Plywood & Laminate`,icon:`fa-layer-group`,desc:`
            <div class="modal-inner-content">
        ...
        `},oilgas:{title:`Oil & Gas`,icon:`fa-droplet`,desc:`
            <div class="modal-inner-content">
        ...
        `}},d=t(),f=()=>{let[e,t]=(0,l.useState)(null),n=e=>{t(u[e]),document.body.style.overflow=`hidden`},f=()=>{t(null),document.body.style.overflow=``};return(0,l.useEffect)(()=>{let t=e=>{e.key===`Escape`&&f()};return e&&window.addEventListener(`keydown`,t),()=>{window.removeEventListener(`keydown`,t)}},[e]),(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(c,{title:`Industries We Serve | Tailored Corporate Risk Solutions`,description:`PIB Insurance provides specialized risk management and insurance solutions tailored to the unique challenges of your industry.`,canonical:`https://pibinsurance.in/industries`}),(0,d.jsx)(`section`,{className:`insurance-hero hero-industries`,children:(0,d.jsx)(`div`,{className:`industries-hero-container`,children:(0,d.jsxs)(o,{className:`industries-hero-content`,children:[(0,d.jsxs)(`div`,{className:`hero-header-row`,children:[(0,d.jsx)(`h1`,{children:`Industries We Serve`}),(0,d.jsx)(`div`,{className:`hero-header-divider`}),(0,d.jsx)(`div`,{className:`hero-header-info`,children:`Dedicated Sector Expertise`})]}),(0,d.jsx)(`p`,{children:`Providing specialized risk management and insurance solutions tailored to the unique challenges of every industry across India.`}),(0,d.jsx)(`div`,{className:`breadcrumb-custom`,children:`HOME / OUR INDUSTRIES`})]})})}),(0,d.jsx)(o,{className:`industries-intro py-5`,children:(0,d.jsx)(`div`,{className:`container text-center`,children:(0,d.jsx)(`p`,{className:`intro-text`,children:`PIB Insurance brokers, helping SMEs and MSMe for a long time to protect their valuable assets. Being in transport or in offices. We serve the following industries.`})})}),(0,d.jsx)(`section`,{className:`industries-section py-5`,children:(0,d.jsx)(`div`,{className:`container`,children:(0,d.jsx)(a,{className:`row g-4`,id:`industriesGrid`,stagger:.08,children:Object.keys(u).map(e=>{let t=u[e];return(0,d.jsx)(s,{className:`col-md-6 col-lg-3`,inherit:!0,children:(0,d.jsxs)(`div`,{className:`industry-card`,onClick:()=>n(e),role:`button`,"aria-label":`View ${t.title} insurance details`,children:[(0,d.jsx)(`div`,{className:`icon-wrap`,children:(0,d.jsx)(`i`,{className:`fa-solid ${t.icon}`})}),(0,d.jsx)(`h4`,{children:t.title}),(0,d.jsx)(`div`,{className:`card-overlay`,children:(0,d.jsxs)(`span`,{children:[`View Details `,(0,d.jsx)(`i`,{className:`fa-solid fa-arrow-right`})]})})]})},e)})})})}),(0,d.jsx)(i,{children:e&&(0,d.jsx)(r.div,{className:`industry-modal active`,id:`industryModal`,onClick:f,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,d.jsxs)(r.div,{className:`modal-content`,onClick:e=>e.stopPropagation(),initial:{scale:.9,opacity:0,y:20},animate:{scale:1,opacity:1,y:0},exit:{scale:.9,opacity:0,y:20},transition:{type:`spring`,damping:25,stiffness:300},children:[(0,d.jsxs)(`div`,{className:`modal-header`,children:[(0,d.jsxs)(`div`,{className:`modal-header-left`,children:[(0,d.jsx)(`div`,{className:`modal-icon`,id:`modalIcon`,children:(0,d.jsx)(`i`,{className:`fa-solid ${e.icon}`})}),(0,d.jsx)(`h2`,{id:`modalTitle`,children:e.title})]}),(0,d.jsx)(`button`,{className:`modal-close`,id:`modalClose`,"aria-label":`Close modal`,onClick:f,children:(0,d.jsx)(`i`,{className:`fa fa-times`})})]}),(0,d.jsx)(`div`,{className:`modal-body`,children:(0,d.jsx)(`div`,{className:`modal-desc`,id:`modalDesc`,dangerouslySetInnerHTML:{__html:e.desc}})})]})})})]})};export{f as default};