import{a as e}from"./chunk-BNv3lrIs.js";import{t}from"./react-BJuGsbII.js";import{t as n}from"./jsx-runtime-kJazARoa.js";var r=e(t(),1),i={it:{title:`IT companies`,icon:`fa-laptop-code`,desc:`
        ...
        `}},a=n(),o=()=>{let[e,t]=(0,r.useState)(null),n=e=>{t(i[e]),document.body.style.overflow=`hidden`},o=()=>{t(null),document.body.style.overflow=``};return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(`section`,{className:`insurance-hero hero-industries`,children:(0,a.jsx)(`div`,{className:`industries-hero-container`,children:(0,a.jsxs)(`div`,{className:`industries-hero-content`,children:[(0,a.jsxs)(`div`,{className:`hero-header-row`,children:[(0,a.jsx)(`h1`,{fetchPriority:`high`,children:`Industries We Serve`}),(0,a.jsx)(`div`,{className:`hero-header-divider`}),(0,a.jsx)(`div`,{className:`hero-header-info`,children:`Dedicated Sector Expertise`})]}),(0,a.jsx)(`p`,{children:`Providing specialized risk management and insurance solutions tailored to the unique challenges of every industry across India.`}),(0,a.jsx)(`div`,{className:`breadcrumb-custom`,children:`HOME / OUR INDUSTRIES`})]})})}),(0,a.jsx)(`section`,{className:`industries-intro py-5`,children:(0,a.jsx)(`div`,{className:`container text-center`,children:(0,a.jsx)(`p`,{className:`intro-text`,children:`PIB Insurance brokers, helping SMEs and MSMe for a long time to protect their valuable assets. Being in transport or in offices. We serve the following industries.`})})}),(0,a.jsx)(`section`,{className:`industries-section py-5`,children:(0,a.jsx)(`div`,{className:`container`,children:(0,a.jsx)(`div`,{className:`row g-4`,id:`industriesGrid`,children:Object.keys(i).map(e=>{let t=i[e];return(0,a.jsx)(`div`,{className:`col-md-6 col-lg-3`,children:(0,a.jsxs)(`div`,{className:`industry-card`,onClick:()=>n(e),role:`button`,"aria-label":`View ${t.title} insurance details`,children:[(0,a.jsx)(`div`,{className:`icon-wrap`,children:(0,a.jsx)(`i`,{className:`fa-solid ${t.icon}`})}),(0,a.jsx)(`h4`,{children:t.title}),(0,a.jsx)(`div`,{className:`card-overlay`,children:(0,a.jsxs)(`span`,{children:[`View Details `,(0,a.jsx)(`i`,{className:`fa-solid fa-arrow-right`})]})})]})},e)})})})}),e&&(0,a.jsx)(`div`,{className:`industry-modal active`,id:`industryModal`,onClick:o,children:(0,a.jsxs)(`div`,{className:`modal-content`,onClick:e=>e.stopPropagation(),children:[(0,a.jsxs)(`div`,{className:`modal-header`,children:[(0,a.jsxs)(`div`,{className:`modal-header-left`,children:[(0,a.jsx)(`div`,{className:`modal-icon`,id:`modalIcon`,children:(0,a.jsx)(`i`,{className:`fa-solid ${e.icon}`})}),(0,a.jsx)(`h2`,{id:`modalTitle`,children:e.title})]}),(0,a.jsx)(`button`,{className:`modal-close`,id:`modalClose`,"aria-label":`Close modal`,onClick:o,children:(0,a.jsx)(`i`,{className:`fa fa-times`})})]}),(0,a.jsx)(`div`,{className:`modal-body`,children:(0,a.jsx)(`div`,{className:`modal-desc`,id:`modalDesc`,dangerouslySetInnerHTML:{__html:e.desc}})})]})})]})};export{o as default};